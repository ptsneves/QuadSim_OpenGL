...
class Motor(object):
    def __init__(self, angle, clockwise, servo):
        ...
        self.rot_accel_contribution_x = -radians(5000.0) * math.sin(radians(angle))
        self.rot_accel_contribution_y =  radians(5000.0) * math.cos(radians(angle))
...
class MultiCopter(Aircraft):
    ...
    def __init__(self, frame='+',
        ...
        self.rotation_terminal_rotation_rate_component_x = radians(5000.0) / self.terminal_rotation_rate
        self.rotation_terminal_rotation_rate_component_y = radians(5000.0) / self.terminal_rotation_rate
        self.rotation_terminal_rotation_rate_component_z = radians(400.0)  / self.terminal_rotation_rate
    ...
    def update(self, servos):
        ...
        for i in range(len(self.motors)):
            rot_accel.x += self.motors[i].rot_accel_contribution_x * m[i]
            rot_accel.y += self.motors[i].rot_accel_contribution_y * m[i]
        ...
        rot_accel.x -= self.gyro.x * self.rotation_terminal_rotation_rate_component_x
        rot_accel.y -= self.gyro.y * self.rotation_terminal_rotation_rate_component_y
        rot_accel.z -= self.gyro.z * self.rotation_terminal_rotation_rate_component_z
